...
int Configuration::_argc = 0;
const char** Configuration::_argv = 0;
...
void Configuration::initialize(const int argc, const char* argv[], bool printLogTree) {
